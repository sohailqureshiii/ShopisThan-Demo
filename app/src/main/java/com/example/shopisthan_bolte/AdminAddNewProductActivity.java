...
public class AdminAddNewProductActivity extends AppCompatActivity {
    ...
    private String Name, Description,Price,Category ,saveCurrentDate, saveCurrentTime;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        InputProductCategory = (EditText) findViewById(R.id.category_product);
    ...
    private void StoreProductInfo()
    {
        ...
        productRandomKey=saveCurrentDate + saveCurrentTime + uid;
